...
namespace Blaster
{
	public class FLAME : MONOBEHAVIOUR
	{
		...
		//-----------------------------------------------------------------------------------------------------
		GAMEOBJECT FlameCenterObject;
		GAMEOBJECT FlameSideObject;
		//-----------------------------------------------------------------------------------------------------
		...
		void Update()
		{
			FlameCenterObject.Renderer.material.SetTexture("_MainTex", TextureArray[Animation]);
			FlameSideObject.Renderer.material.SetTexture("_MainTex", TextureArray[Animation]);

			Animation++;
			if (Animation >= TextureArray.Length) Animation = 0;
		}
		//-----------------------------------------------------------------------------------------------------
	}
}
